...
The best way to understand how DivUp Content works (including the advanced aspects) is to **copy and paste the following dummy content into a post or page and then inspect the html with firebug** - paying attention to the CSS classes it automatically applies to the divs.
